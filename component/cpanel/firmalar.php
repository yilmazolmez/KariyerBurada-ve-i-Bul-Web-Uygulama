				        ...
				        <table class="table table-hover">
						  ...
						  <tbody>
						  	<?php
									...
									$sorgu1 = mysqli_query($baglan,"SELECT COUNT(*) AS toplam FROM uyefirmabilgi ");
									...
									$limit = ($sayfa - 1) * $sayfada;
						  			...
						  			$sql="select * from uyefirmabilgi order by uyefirmano desc limit $limit,$sayfada";
									...
									echo "<div class=container><div class=row><div class=col-md-12 ><span style=float:right;font-weight:bold;margin-bottom:5px;>toplam firma:$toplam_icerik</span></div></div></div>";
						    ...
						    <tr>
						      ...
						      <td><?php echo $sonuc["uyefirmaeposta"]; ?></td>
						      <td><?php echo $sonuc["uyefirmatelefonno"]; ?></td>
						      <td><a href="firmacvgoster.php?id=<?php echo $sonuc["uyefirmano"]; ?>#git" target="_blank" style="color: green;">
							...
							<td style="text-align: center;"><a href="firmalar.php?id=<?php echo $sonuc['uyefirmano']; ?>" name="sil" style="color: red;"> <svg width="2em" height="2em" viewBox="0 0 16 16" class="bi bi-x-square-fill" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
						    ...
						    <?php
						    	$a++;
						   		 			...
						   		 			if($_GET["id"])
											{
														...
														$sql = "DELETE from uyefirmabilgi where uyefirmano='".$_GET["id"]."'";
														$sonuc= mysqli_query($baglan,$sql);
														if($sonuc) 
														{ 			
															 
															header("refresh:1,url=firmalar.php#git");						 					
														}
														else
														{

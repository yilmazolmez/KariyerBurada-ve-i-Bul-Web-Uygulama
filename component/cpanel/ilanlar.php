				        ...
				        <table class="table table-hover">
						  <thead>
						    <tr>
						      ...
						      <th scope="col">Başvuran Sayısı</th>
						  ...
						  <tbody>
						  	<?php
									...
									$sorgu1 = mysqli_query($baglan,"SELECT COUNT(*) AS toplam FROM uyefirmaisilanbilgi ");
									...
									$limit = ($sayfa - 1) * $sayfada;
						  			...
						  			$sql="select * from uyefirmaisilanbilgi order by isilanno  desc limit $limit,$sayfada";
									...
									echo "<div class=container><div class=row><div class=col-md-12 ><span style=float:right;font-weight:bold;margin-bottom:5px;>toplam ilan:$toplam_icerik</span></div></div></div>";
									while($sonuc=mysqli_fetch_assoc($result))
									{
						  	?>
						    <tr>
						      <th scope="row"><?php echo $a; ?></th>
						      <td><?php echo $sonuc["uyefirmaunvani"]; ?></td>
						      <td><?php echo $sonuc["issehir"]; ?></td>
						      <td><?php echo $sonuc["meslek"]; ?></td>
						      <td><?php echo $sonuc["isbasvurubaslamatarihi"]; ?></td>
						      <?php
						      	$yenisorgu="select count(*) as toplam from uyefirmaisilanbasvurubilgi where isilanno='".$sonuc["isilanno"]."'";
						      	$result11=mysqli_query($baglan,$yenisorgu);	
						      	$sonuc11=mysqli_fetch_assoc($result11);
						      ?>
						      <td><?php echo $sonuc11["toplam"]; ?></td>
						      <td><a href="ilangoster.php?id=<?php echo $sonuc["isilanno"]; ?>#git" target="_blank" style="color: green;">
							...
							<td style="    text-align: center;"><a href="ilanlar.php?id=<?php echo $sonuc['isilanno']; ?>" name="sil" style="color: red;"> <svg width="2em" height="2em" viewBox="0 0 16 16" class="bi bi-x-square-fill" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
						   		 ...
						   		 if($_GET["id"])
											{
														...
														{ 			
															...
															header("refresh:1,url=ilanlar.php#git");						 					
														}
														else
														{

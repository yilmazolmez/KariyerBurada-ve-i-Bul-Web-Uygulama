				...
				<section>
					...
					<div class="container main-kisiler-hover" style="margin-top:20px;">
						...
						<div class="row">
							...
							$sorgu1 = mysqli_query($baglan,"SELECT COUNT(*) AS toplam FROM uyefirmaisilanbilgi where meslek like '%$unvan%' and issehir like '%$sehirler%' and uyefirmaunvani like '%$firma%' and tur like '%$tur%' and isbasvurubitistarihi>='".$bugunun_tarihi."'");
							...
							$limit = ($sayfa - 1) * $sayfada;
								...
								$sql = "select * from uyefirmaisilanbilgi where meslek like '%$unvan%' and issehir like '%$sehirler%' and tur like '%$tur%' and uyefirmaunvani like '%$firma%'  and  isbasvurubitistarihi>='".$bugunun_tarihi."' order by isilanno desc  limit $limit,$sayfada ";
							...
							<div class="col-md-12">
									...
									<div class="card shadow mb-5 shadow mb-5">
										<div class="row">
											<div class="col-md-4">
												<div style="width:100%;
											background-image: url('<?php echo $sonuc['resim'] ?>');
											...
											<div class="col-md-8">
												<div class="card-body">
													<h6 class="card-title"><?php echo mb_strtoupper($sonuc['uyefirmaunvani']) ?>
														<?php
															if($_SESSION["login"]=="uye"){
														?>
														<span>
															<form method="post" action="">
																<button id="test" class="loginbuton" style="float: right; " name="ilandetay" onclick="window.open('ilandetay.php?id=<?php echo $sonuc['isilanno']?>#git')"  >Başvuru Detay</button>
															</form>
														</span>
														<?php
														 }
														 ...
														 {
														 	echo "<span style=float:right;>Başvuru yapmak için <b>Üye Girişi</b> yapınız. </span>";
														 }

														 
														?>
													</h6>
													<p class="card-text"><?php echo $sonuc['issehir'] ?></p>
													<h6 class="card-title"><?php echo $sonuc['meslek'] ?></h6>
													<p class="card-text"><?php echo $sonuc['isaciklamasi'] ?></p>
													<span style="float: right;">Yayınlanma Tarihi : <b><?php echo $sonuc['isbasvurubaslamatarihi'] ?></b></span><br>
													<span style="float: right;">Başvuru Bitiş Tarihi : <b><?php echo $sonuc['isbasvurubitistarihi'] ?></b></span>
												</div>
											</div>
										</div>
